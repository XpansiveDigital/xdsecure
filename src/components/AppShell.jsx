...
export default function AppShell() {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-stone-50">
      ...
      {/* ── Header ── */}
      <header className="sticky top-0 z-50 h-14 flex items-center bg-white/90 backdrop-blur-md border-b border-zinc-200/80 shadow-[0_1px_0_rgba(0,0,0,0.04)]">
        <div className="w-full px-5 flex items-center justify-between gap-4">

          {/* Logo */}
          <div className="flex items-center gap-2.5 shrink-0 w-44">
            <div className="w-7 h-7 rounded-lg bg-slate-900 flex items-center justify-center shadow-[0_1px_2px_rgba(0,0,0,0.2)]">
            ...
            <div>
              ...
              <div className="text-[9px] text-zinc-400 font-semibold tracking-[0.15em] uppercase leading-none mt-0.5">by XD</div>
            </div>
          </div>

          {/* Centre nav — pill tray */}
          <nav className="flex items-center flex-1 justify-center">
            <div className="flex items-center bg-zinc-100/80 rounded-xl p-1 gap-0.5">
              ...
              {/* Divider */}
              <div className="w-px h-4 bg-zinc-300/60 mx-0.5" />
          ...
          <div className="flex items-center gap-2 shrink-0 w-44 justify-end">
            <span className={`inline-flex items-center gap-1.5 text-[11px] font-semibold px-2.5 py-1 rounded-full border transition-colors ${
